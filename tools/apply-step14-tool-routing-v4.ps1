...
# The generated script uses LF while Java sources use CRLF on this workstation.
# Normalize each search fragment in memory before running the guarded V3 procedure.
